...
if (!class_exists('Shelterluv_Animals_PostType')) {
	class Shelterluv_Animals_PostType
	{
		const SLUG = "animal";
		...
		public function init()
		{
			...
			register_post_type(
				...
				array(
					...
					'show_ui' => true,
					'has_archive' => 'adopt',
					'show_in_menu' => Shelterluv_Animals_Settings::SLUG,
					'rewrite' => 'true',
				)
			);
	...
	} // END class Shelterluv_Animals_PostType
} // END if(!class_exists('Shelterluv_Animals_PostType'))