 ...
 * @since             1.0.0
 * @package           [little_green_light_integration]
 *
 * @wordpress-plugin
 * Plugin Name:       Integrate LGL
 * Plugin URI:        https://github.com/askinne2/Little-Green-Light-Integration
 *
 * Description:       Creates a customizable integration between website and a Little Green Light database account
 *
 *
 * Version:           0.0.1
 ...
 * Text Domain:       little_green_light_integration
...
require_once 'little_green_light_integration_includes.php';
require_once 'little_green_light_integration_acf.php';
require_once 'includes/smush-integration.php';
require_once 'includes/acf-pro/acf.php';

class Little_Green_Light_Integration
{
	...
	var $request_uri;
	var $args;
	var $little_green_light_integration;
	var $petID_array;
...
/*
	...
	public function run_update()
	{
		...
		$this->request_uri = 'https://api.littlegreenlight.com/api/v1/constituents?access_token=jzoqChDdn58cE5kZknzQSO0HsqZG9YyFkCNaBDawu9SvmgXAqXBu8aRoE7h4ynYwJI71AnK6DsF1Tvj9IAUD8A';
...
$pets = new Little_Green_Light_Integration();
