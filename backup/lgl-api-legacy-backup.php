...
*
* Description:       Connects website to Little Green Light database account
*
*
* Version:           1.0.0
...
//require_once 'includes/lgl_constants.php';

require_once 'includes/lgl-connections.php';
require_once 'includes/lgl-helper.php';
require_once 'includes/decrease_registration_counter_on_trash.php';
require_once 'includes/lgl-wp-users.php';
require_once 'includes/test_requests.php';
require_once 'includes/ui_memberships/ui_memberships.php';

// Load new admin and email functionality (moved from theme)
require_once 'includes/admin/dashboard-widgets.php';
require_once 'includes/email/daily-email.php';
require_once 'includes/email/email-blocker.php';
require_once 'includes/woocommerce/subscription-renewal.php';

// Load cache manager for performance optimization
require_once 'includes/lgl-cache-manager.php';

// Load shared utilities (moved from theme)
require_once 'includes/lgl-utilities.php';
